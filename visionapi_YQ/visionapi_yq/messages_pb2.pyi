...
class Detection(_message.Message):
    __slots__ = ["bounding_box", "class_id", "confidence", "feature", "geo_coordinate", "object_id", "timestamp_utc_ms"]
    ...
    def __init__(self, bounding_box: Optional[Union[BoundingBox, Mapping]] = ..., confidence: Optional[float] = ..., class_id: Optional[int] = ..., object_id: Optional[int] = ..., geo_coordinate: Optional[Union[GeoCoordinate, Mapping]] = ..., feature: Optional[Iterable[float]] = ..., timestamp_utc_ms: Optional[int] = ...) -> None: ...
...
class Metrics(_message.Message):
    ...
    MERGE_INFERENCE_TIME_US_FIELD_NUMBER: ClassVar[int]
    ...
    def __init__(self, detection_inference_time_us: Optional[int] = ..., tracking_inference_time_us: Optional[int] = ..., feature_extraction_time_us: Optional[int] = ..., merge_inference_time_us: Optional[int] = ...) -> None: ...
...
class Tracklet(_message.Message):
    __slots__ = ["age", "detections_info", "end_time", "entry_zone", "exit_zone", "mean_feature", "motion_vector", "start_time", "status"]
    ...
    MOTION_VECTOR_FIELD_NUMBER: ClassVar[int]
    ...
    start_time: int
    status: str
    def __init__(self, mean_feature: Optional[Iterable[float]] = ..., status: Optional[str] = ..., start_time: Optional[int] = ..., end_time: Optional[int] = ..., entry_zone: Optional[str] = ..., exit_zone: Optional[str] = ..., detections_info: Optional[Iterable[Union[Detection, Mapping]]] = ..., age: Optional[int] = ..., motion_vector: Optional[Union[MotionVector, Mapping]] = ...) -> None: ...
...
class VideoFrame(_message.Message):
    ...
    source_id: str
    timestamp_utc_ms: int
    def __init__(self, source_id: Optional[str] = ..., timestamp_utc_ms: Optional[int] = ..., shape: Optional[Union[Shape, Mapping]] = ..., frame_data: Optional[bytes] = ..., frame_data_jpeg: Optional[bytes] = ..., frame_id: Optional[int] = ...) -> None: ...
